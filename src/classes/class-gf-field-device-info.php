...
class GF_Field_AlquemieDeviceInfo extends GF_Field {

	public $type = 'aqDeviceInfo';

	public function get_form_editor_field_title() {
		return esc_attr__( 'Device Info', 'gf-campaign-fields' );
	}
	...
	public function get_form_editor_field_description() {
		return esc_attr__( 'JSON Object containing the visitors device information.', 'gf-campaign-fields' );
	}
    ...
    return esc_url( plugins_url( 'dist/img/devices.png', dirname(__FILE__, 2) ) );
	}
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		$input = sprintf( "<input name='input_%d' id='%s' data-alquemie='device' type='$field_type' {$class_attribute} {$required_attribute} {$invalid_attribute} value='%s' %s/>", $id, $field_id, esc_attr( $value ), $disabled_text );
...
GF_Fields::register( new GF_Field_AlquemieDeviceInfo() );
