...
class GF_Field_Alquemie_Campaign_Info extends GF_Field {
  ...
  public function get_form_editor_button()
    ...
    return esc_url( plugins_url( 'dist/img/data-analytics.png', dirname(__FILE__, 2) ) );
	}
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		$input = sprintf( "<input name='input_%d' id='%s' data-alquemie='campaign' type='$field_type' {$class_attribute} {$required_attribute} {$invalid_attribute} value='%s' %s/>", $id, $field_id, esc_attr( $value ), $disabled_text );
...
GF_Fields::register( new GF_Field_Alquemie_Campaign_Info() );
